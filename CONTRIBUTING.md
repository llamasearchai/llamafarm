...
Thank you for your interest in contributing to LlamaFarm! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaFarm:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamafarm.git
   cd llamafarm
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamafarm.git
   ```
...
By contributing to LlamaFarm, you agree that your contributions will be licensed under the project's MIT License.
